...
'''
fonction qui retourne une figure avec bruit flurescent
'''
def Add_noise(image_path, N_Biologic_noise,noisy_dust, pepper, perlage):

    imag = plt.imread(image_path)
    
    image = imag[:,:, :3]
    
    fig, ax = plt.subplots(1, 1, figsize=(100, 100), sharex=True, sharey=True, dpi=100)
...
image_path = './sm_with_coord/essai/noisy_curves/image_0.png'
import math
from PIL import Image
fig = Add_noise(image_path, N_Biologic_noise,noisy_dust, pepper, perlage)
